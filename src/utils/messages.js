...
import { firstLetterToLowerCase, firstLetterToUpperCase } from './helperFunctions';
...
const messages = {
    ...
    "server.src.datasources.user": {
        ...
        login: {
            ...
            erroExists: "This user does not exist."
        }
    },
}
...
export const createSuccess = (type) => `${firstLetterToUpperCase(type)} created succesfully.`
export const createExists = (type) => `${firstLetterToUpperCase(type)} with this name already exists.`
export const deleteSuccess = (type) => `${firstLetterToUpperCase(type)} sucessfully deleted.`
export const deleteExists = (type) => `${firstLetterToUpperCase(type)} with this id does not exist.`
export const deleteNotAllowed = (type) => `You can't delete this ${firstLetterToLowerCase(type)}.`
